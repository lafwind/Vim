...
" Default GUI Colours
let s:foreground = "6d6d6c" "lafwind 4d4d4d
let s:background = "fdf6e9" "lafwind fafafa ver_1: f1f1f1 Solarized: fdf6e3
let s:selection = "d6d6d6"
let s:line = "fdf6dd" "lafwind efefef ver_1: eaeaea Solarized:eee8d5
...
let s:blue = "4271ae"
let s:purple = "8959a8"
let s:window = "fdf6e9" "lafwind efefef ver_1: f1f1f1 Solarized: fdf6e3
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  highlight LineNr term=bold cterm=NONE ctermfg=DarkGrey ctermbg=NONE gui=NONE guifg=DarkGrey guibg=NONE
	...
	call <SID>X("StatusLine", s:laf_So, s:yellow, "reverse") "lafwind s:line
