...
let g:colors_name = "Lafwind_Night_Term_Ver2"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  highlight LineNr term=bold cterm=NONE ctermfg=DarkGrey ctermbg=NONE gui=NONE guifg=DarkGrey guibg=NONE
	...
	call <SID>X("Search", s:laf_yellow, s:laf_blue, "")
	...
	call <SID>X("StatusLine", s:laf_black, s:laf_life, "reverse") "lafwind s:line
