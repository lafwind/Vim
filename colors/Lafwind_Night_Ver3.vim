...
let s:line = "2a2a2a"
let s:comment = "cfa0c0" "8e908c magenta: d33682
let s:red = "c82829"
let s:orange = "c1871f"
let s:yellow = "f1f169" "eab700
let s:green = "669f00"     "66af00
let s:aqua = "0a999f"
let s:blue = "1980ff"
let s:purple = "b7222b"
...
let g:colors_name = "Lafwind_Day_Ver2"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
  ...
  highlight LineNr term=bold cterm=NONE ctermfg=DarkGrey ctermbg=NONE gui=NONE guifg=DarkGrey guibg=NONE
	call <SID>X("LineNr", s:comment, s:laf_So, "") "lafwind s:line
	call <SID>X("NonText", s:selection, "", "")
	call <SID>X("SpecialKey", s:comment, "", "")
	call <SID>X("Search", s:background, s:laf_gold, "")
	...
	call <SID>X("Function", s:laf_blue, "", "")
	call <SID>X("Constant", s:orange, "", "")
	call <SID>X("String", s:laf_purple, "", "")
	...
	call <SID>X("pythonFunction", s:laf_blue, "", "")
